...
use App\Http\Controllers\Backend\RegisterCollege;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
Route::middleware('tenant')->group(function () {
    ...
    Route::group(
        ['namespace' => 'Backend', 'middleware' => ['guest']],
        function () {
    ...
    Route::group(
        ['namespace' => 'Backend', 'middleware' => ['auth', 'permission']],
        function () {
...
Route::group(['namespace' => 'Backend'], function () {
    Route::get('/college-registration', [RegisterCollege::class, 'register'])->name('register');
    Route::post('/college-registration', [RegisterCollege::class, 'store'])->name('store-college');
    Route::get('logs', '\Rap2hpoutre\LaravelLogViewer\LogViewerController@index')
        ->name('app_log');
    Route::get('/college-registration-details', [RegisterCollege::class, 'post_register'])->name('post-register');
    Route::get('/test', [RegisterCollege::class, 'test'])->name('test');
});
